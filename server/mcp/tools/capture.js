  ...
  tools.push({
    ...
    handler: async (args, cb) => {
      ...
      try {
        ...
        // Secret-guard screenshot masking is applied worker-side in
        // screenshot-manager.capture (so it works over MCP stdio, HTTP, and the
        // proxy forward alike), not here in the MCP layer.
