...
server/index.js          ← エントリーポイント。HTTP:7892 + WS:7891 を立ち上げ
    ...
    ├── server/mcp-server.js     ← MCP層 (71ツール)
...
| **intelligence** (+7) | 自動 | explain_element, why_did_this_change, get_source_file, detect_site_updates, get_source_context, capture_sources, ocr_region | "explain", "why", "source", "cause", "ocr", "canvas" | 5ターン |
